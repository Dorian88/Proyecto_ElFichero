...
public class ListFragmentSencillo extends android.app.ListFragment implements LoaderCallbacks<Cursor>{
    private static final String TAG = ListFragmentSencillo.class.getSimpleName();
    ...
    private static final int TO[] = { R.id.list_item_text_user
            //, R.id.list_item_text_message2
            //, R.id.list_item_text_created_at2
    };
    ...
    private static final ViewBinder VIEW_BINDER = new ViewBinder() {
        ...
        public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
            ...
            /*
            switch(view.getId()) {
                case R.id.detail_item_text_created_at:
